...
export class StudentNav extends Component {
    render() {
        return (
            <div>
                <nav className="navbar sticky-top navbar-expand-md navbar-dark bg-dark">
                    ...
                    <div className="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
                        <ul className="navbar-nav mr-auto">
                            <li>
                                <NavLink to="/StudentHome" activeClassName="active-link" className="nav-link">Home</NavLink>
                            </li>
                            <li>
                            ...
                            <li>
                                <NavLink to="/StudentCourses" activeClassName="active-link" className="nav-link">My Courses</NavLink>
                            </li>
                            <li>
                                <NavLink to="/studentProfile" activeClassName="active-link" className="nav-link">My Profile</NavLink>
                            </li>
                        </ul>
                    </div>
