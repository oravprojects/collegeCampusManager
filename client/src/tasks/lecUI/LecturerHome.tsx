...
export class LecturerHome extends Component {
    componentDidMount() {
    ...
    updateList = () => {
        ...
        // var request = ""
        // for (var i = 0; i < remArr.length; i++) {
        //     var checkVal = document.getElementById("check" + remArr[i].rem_id) as HTMLInputElement
        //     if (checkVal.checked) {
        //         request += "UPDATE `reminders` SET complete = 1 where rem_id = " + remArr[i].rem_id + "; "
        //     } else {
        //         request += "UPDATE `reminders` SET complete = 0 where rem_id = " + remArr[i].rem_id + "; "
        //     }
        // }
